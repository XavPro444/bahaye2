...
{
    class TuileTexturéeVertical2 : TuileVertical2
    {
        ...
        public TuileTexturéeVertical2(Game jeu, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, Vector2 étendue, string nomTextureTuile, float intervalleMAJ)
