...
{
    class TuileTexturéeVertical4 : TuileVertical4
    {
        ...
        public TuileTexturéeVertical4(Game jeu, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, Vector2 étendue, string nomTextureTuile, float intervalleMAJ)
