...
{
    class TuileDiagonalTexturé3 : TuileDiagonal3
    {
        ...
        public TuileDiagonalTexturé3(Game jeu, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, Vector2 étendue, string nomTextureTuile, float intervalleMAJ)
