...
{
    public abstract class TuileDiagonal3 : PrimitiveDeBaseAnimée
    {
        ...
        public TuileDiagonal3(Game jeu, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, Vector2 étendue, float intervalleMAJ)
