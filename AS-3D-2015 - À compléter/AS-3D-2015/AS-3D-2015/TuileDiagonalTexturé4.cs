...
{
    class TuileDiagonalTexturé4 : TuileDiagonal4
    {
        ...
        public TuileDiagonalTexturé4(Game jeu, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, Vector2 étendue, string nomTextureTuile, float intervalleMAJ)
