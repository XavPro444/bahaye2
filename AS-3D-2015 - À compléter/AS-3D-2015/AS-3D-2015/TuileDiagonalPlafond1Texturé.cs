...
{
    class TuileDiagonalPlafond1Texturé : TuileDiagonalPlafond1
    {
        ...
        public TuileDiagonalPlafond1Texturé(Game jeu, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, Vector2 étendue, string nomTextureTuile, float intervalleMAJ)
