...
{
    public abstract class TuileVertical4 : PrimitiveDeBaseAnimée
    {
        ...
        public TuileVertical4(Game jeu, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, Vector2 étendue, float intervalleMAJ)
