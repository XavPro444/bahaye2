...
{
    public class TuileTexturéePlafond : TuilePlafond
    {
        ...
        public TuileTexturéePlafond(Game jeu, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, Vector2 étendue, string nomTextureTuile, float intervalleMAJ)
