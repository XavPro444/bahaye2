...
{
    public class TuileDiagonalTexturé : TuileDiagonal
    {
        ...
        public TuileDiagonalTexturé(Game jeu, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, Vector2 étendue, string nomTextureTuile, float intervalleMAJ)
