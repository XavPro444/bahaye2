...
{
    class TuileTexturéeVertical3 : TuileVertical3
    {
        ...
        public TuileTexturéeVertical3(Game jeu, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, Vector2 étendue, string nomTextureTuile, float intervalleMAJ)
