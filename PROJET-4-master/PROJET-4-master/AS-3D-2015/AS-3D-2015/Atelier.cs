...
namespace AtelierXNA
{
   public class Atelier : Microsoft.Xna.Framework.Game
   {
      ...
      protected override void Initialize()
      {
         ...
         Vector3 positionCaméra = new Vector3(-8, 7, 46);
         ...
         Components.Add(new TuileTexturéeVertical2(this, 1f, Vector3.Zero, new Vector3(50, 0,48), new Vector2(7, 9.9f), "MurIntérieurPavillon", INTERVALLE_MAJ_STANDARD));
         Components.Add(new TuileTexturéeVertical(this, 1f, Vector3.Zero, new Vector3(50, 0, 47.8f), new Vector2(7, 9.9f), "MurIntérieurPavillon", INTERVALLE_MAJ_STANDARD));
         ...
         Components.Add(new TuileTexturéeVertical3(this, 1f, Vector3.Zero, new Vector3(53.49f, 0, 27f), new Vector2(42f, 9.9f), "MurIntérieurPavillon", INTERVALLE_MAJ_STANDARD));
